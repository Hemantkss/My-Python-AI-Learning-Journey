    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if self.user_controls['selected_llm'] == "OpenAI":
                ...
                # for OpenAI API Key
                self.user_controls["OPENAI_API_KEY"] = st.session_state["OPENAI_API_KEY"] = st.text_input("Enter API Key", type= "password")
            ...
            # TAVILY API Key for Web Chatbot and AI News Usecase
