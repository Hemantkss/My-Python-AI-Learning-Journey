...
os.environ['LANGSMITH_PROJECT'] = "RAG_v2"
...
PDF_PATH = "book.pdf"  # change to your file

# ---------- traced setup steps ----------
@traceable(name="load_pdf", tags=["book_pdf"], metadata={"loader": "PyPDFLoader"})
...
@traceable(name="build_vectorstore", tags=["Embeddings", "FAISS", "vectorstore"], metadata={"model": "text-embedding-3-small"})
